...
const services = [
  { label: "Hiperautomatización", href: "/hiperautomatizacion" },
  { label: "Marketing Digital", href: "/marketing-digital" },
  { label: "Seguridad Inteligente", href: "/seguridad-inteligente" },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-slate-400 text-sm leading-relaxed max-w-xs mb-6">
              Transformamos empresas mediante Inteligencia Artificial, Automatización y
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-slate-500">
            © {new Date().getFullYear()} 01pixels. Todos los derechos reservados.
          </p>
